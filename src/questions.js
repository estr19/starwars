export const questions = [
  ...
  {
    text: 'Who is the only non Jedi in the original Star Wars trilogy to use a lightsaber?',
    options: [
      { id: 0, text: 'HAN SOLO', isCorrect: true },
      { id: 1, text: 'PRINCESS LEIA', isCorrect: false },
      { id: 2, text: 'R2-D2', isCorrect: false },
      { id: 3, text: 'CHEWBACCA', isCorrect: false },
    ],
  },
  {
  ...
  {
    text: 'What does Han say when Leia first tells him that she loves him?',
    options: [
      { id: 0, text: `"IT'S ABOUT TIME"`, isCorrect: false },
      { id: 1, text: `"I KNOW"`, isCorrect: true },
      { id: 2, text: `"I FIGURED"`, isCorrect: false },
      { id: 3, text: `"I LOVE YOU, TOO"`, isCorrect: false },
    ],
  },
  {
